...
//	private static String destinationDbPath = "C:/Users/prans/Documents/capstone/co_author_network/neo4j/co_author_network/";
	...
	public static void main(String[] args) {
		try {
			initailizeDb();
			//fetch nodes with degree < given from aux dataLoading
			long kClass = 0;
			long nodesCount = fetchNodeCount();
			while(nodesCount > 0) {
				//remove the nodes from aux dataLoading
				ArrayList<Long> deletedNodes = deleteNodesWithGivenKClass(kClass);
				//update the property values for these nodes in main dataLoading or write in file
