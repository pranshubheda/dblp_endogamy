...
CREATE DATABASE IF NOT EXISTS dblp_test;
USE dblp_test;
...
CREATE TABLE `author` (
  ...
  `paper_key` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `paper_id` mediumint(9) DEFAULT NULL,
  `author_rank` int(11) DEFAULT '0'
...
CREATE TABLE `paper` (
  ...
  `conference` text COLLATE utf8mb4_bin,
  `paper_key` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person` (
  ...
  `primary_alias` int(11) DEFAULT NULL,
